 ...
 */
public class ChatClient extends JFrame implements Callback {
    ...
    public class LoginAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
        	// PopUp the ConnectDialog
            ConnectDialog dialog = new ConnectDialog(ChatClient.this);
            dialog.pack();
            dialog.setVisible(true);

            if (dialog.isCancelled()) {
            	// When ConnectDialog Canceled, Event beak;
                return;
            }
            
            // Get Address and name value to ConnectDialog
    ...
    public static void main(String[] args) {
    	// Initial Function, Create Main Panel
